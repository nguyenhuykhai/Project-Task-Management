  ...
  return (
    <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 py-6 border-b border-border">
      <div className="flex-1">
        ...
        <p className="text-muted-foreground text-xs md:text-sm mt-2">Manage your team's sprints and track progress</p>
      </div>
      ...
      <div className="flex items-center gap-2 md:gap-3 w-full md:w-auto">
        ...
        <label htmlFor="import-file" className="inline-flex items-center justify-center h-10 w-10 rounded-md hover:bg-accent hover:text-accent-foreground cursor-pointer transition-colors">
          <Upload size={20} />
          <input
            type="file"
            id="import-file"
